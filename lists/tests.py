...
class HomePageTest(TestCase):
    ...
    def test_root_url_points_to_home_page_view(self):
        found = resolve('/')
...
class ListViewTest(TestCase):
    ...
    def test_displays_all_items(self):
        ...
        Item.objects.create(text='other itemey 1', list=otherlist_)
        Item.objects.create(text='other itemey 2', list=otherlist_)
...
class NewListTest(TestCase):
    ...
    def test_additem_redirects_to_list_view(self):
        other_list = List.objects.create()
        list_ = List.objects.create()
        response = self.client.post(
